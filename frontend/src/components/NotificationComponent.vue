<template>
    ...
    >
        ...
        <q-badge floating color="red" v-if="notificationStore.notifications.length > 0">
            {{
        ...
        <q-menu transition-show="scale" transition-hide="scale">
            ...
            >
                <q-list>
                    <q-item clickable v-close-popup @click="handleClick(notification)">
                        ...
                        <q-item-section>
                            ...
                            <q-item-label caption>{{
                                dayjs(notification.created_at).format('MMMM DD, YYYY')
                            }}</q-item-label>
                        </q-item-section>
                    </q-item>
                </q-list>
            ...
            switch (notification?.model) {
                ...
                case 'ProductStockAlert':
                    ...
                    await this.$router.push({
                        path: '/product-management/products/' + notification?.subject_id,
                    });
                    this.generalStore.setUpdateId(notification.subject_id);
                    break;
                case 'product-expiration':
