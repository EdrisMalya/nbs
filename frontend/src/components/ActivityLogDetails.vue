        ...
        <q-card class="md:min-w-[800px]">
            ...
            <q-card-section>
                <server-data
                    :from-resource="false"
                    :url="
                        appRoutes.user_management.activity_log.api.get_log.replace(':log', log.id)
                    "
                    v-slot="{ data }"
                >
                    <div class="flex flex-col space-y-1">
                        ...
                        <p class="text-sm">
                            ...
                            {{ dayjs(data?.created_at).format('YYYY-MM-DD hh:mm:ss A') }}
                        </p>
                        <br />
                    </div>
                            ...
                            <table class="w-full !text-center">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td>
                                            <span
                                                v-if="key === 'created_at' || key === 'updated_at'"
                                            >
                                                {{
                                                    dayjs(data.properties.attributes[key]).format(
                    ...
                    <div v-if="data.event === 'updated'">
                        <table class="border text-center w-full">
                            ...
                            <tbody>
                                <tr
                                    v-for="(key, index) in Object.keys(data.properties.attributes)"
                                    :key="index"
                                    class="border-b"
                                ...
                                >
                                    ...
                                    <td class="w-[40%] border-r py-1 bg-red-500 text-white">
                                        {{ data.properties.old[key] }}
                                    </td>
                                    <td class="w-[40%] border-r py-1 bg-green-500 text-white">
                                        {{ data.properties.attributes[key] }}
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div v-if="data.event === 'deleted'">
                        <table class="w-full !text-center">
                            ...
                            <tbody>
                                <tr
                                    v-for="(key, index) in Object.keys(data.properties.old)"
                                    :key="index"
                                    class="border-b"
                                >
                                    <td>
                    ...
                    <q-card-actions align="right">
                        ...
                        <q-btn color="red" @click="handleModal(false, null)"> Close </q-btn>
                    </q-card-actions>
                </server-data>
            </q-card-section>
        </q-card>
