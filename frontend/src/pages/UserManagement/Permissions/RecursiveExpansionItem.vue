    ...
    >
        <q-card>
            <q-card-section>
                ...
                <q-list v-if="childes.length > 0" bordered class="rounded-borders my-5" dense>
                ...
                <div class="flex items-center space-x-1">
                    <q-btn
                        ...
                        round
                        color="warning"
                        @click="handlePermissionGroupModelOpen(id, 'permission-group', label, icon)"
                    >
                        <q-icon name="edit" />
                    ...
                    <q-btn
                        ...
                        round
                        color="primary"
                        @click="handlePermissionGroupModelOpen(id, 'permission-group', null, null)"
                    >
                        <q-icon name="add" />
