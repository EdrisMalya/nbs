<template>
    <div class="md:px-3 py-4">
        <div class="flex items-center justify-between">
            ...
            <protected-component permission-key="roles-create">
                <q-btn color="primary" size="small" icon-right="add" @click="handleModelOpen">
        ...
        <div v-else>
            ...
            <div v-else class="py-3">
                <q-chip
                    ...
                    :clickable="authStore.isAllowed('roles-view-details')"
    ...
    <role-form-model :mutate="mutate" :model="model" :handle-model-close="handleModelClose" />
</template>
<script>
...
export default defineComponent({
    name: 'RolePage',
    components: { RoleFormModel, ProtectedComponent },
    setup() {
        ...
        const { data, mutate } = useSWRV(appRoutes.user_management.roles.api, fetcher);
