                    ...
                    <q-card-section>
                        <div class="flex items-center border-b">
                            <protected-component
                                v-for="link in [
                                    {
                                        permission: 'reporting-financial-reporting',
                                    ...
                                    {
                                        permission: 'reporting-warehouse-reports',
                                    ...
                                    {
                                        permission: 'reporting-customers-report',
                                    ...
                                    {
                                        permission: 'reporting-supplier-reports',
